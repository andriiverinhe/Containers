...
TEST(TEST_STACK, Constructor_Copy) {
  s21::stack<int> our_stack = {1, 2, 3};
...
TEST(TEST_STACK, Constructor_Move) {
  s21::stack<int> our_stack = {1, 2, 3};
...
TEST(TEST_STACK, InsertManyFront1) {
  s21::stack<int> our_stack_int;
  our_stack_int.insert_many_front(1, 2, 3);
  EXPECT_EQ(our_stack_int.top(), 3);
}

TEST(TEST_STACK, InsertManyFront2) {
  s21::stack<int> our_stack_int{5, 5, 5};
  our_stack_int.insert_many_front(1, 2, 3);
  our_stack_int.insert_many_front();
  EXPECT_EQ(our_stack_int.top(), 3);
}